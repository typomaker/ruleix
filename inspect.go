...
// MemoryLimit reports the effective representation byte limit after applying
// every ancestor policy limit.
...
// Granularity reports the selected number of quantized key classes.
