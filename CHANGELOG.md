...
- Restored warm and parallel `Local.Search` performance by separating grouped
  query validation from the ordinary prepared cache-slot lookup. Comparable
  release measurements are recorded in
  [`docs/performance-history.md`](docs/performance-history.md); no aggregate
  release benchmark exists yet.
...
[Unreleased]: https://github.com/typomaker/ruleix/compare/v0.8.4...HEAD
[0.8.4]: https://github.com/typomaker/ruleix/compare/v0.8.3...v0.8.4
[0.8.3]: https://github.com/typomaker/ruleix/compare/v0.8.2...v0.8.3
