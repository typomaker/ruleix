...
// results produced by Include, Exclude, ordered-filter, CompareBy, and Between
// nodes, making it useful when adjacent searches repeat some constraint values.
// Create a separate Local for each goroutine.
