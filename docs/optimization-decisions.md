...
| Универсальные lossy minima для heterogeneous production `All` | Полная 38 098-entry production-схема с 50% budget собирается; Index median 31,620 ns/op, 62,410 B/op, 21 allocs/op, warm Local 1,901 ns/op, 0 B/op, 0 allocs/op. | Полный bitmap листа гарантирует superset для произвольного comparator/comparable; специализированные codecs остаются отдельными более точными уровнями. |
